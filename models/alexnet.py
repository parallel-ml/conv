...
def filter():
    ...
    x = filter_unit(x, 128, (5, 5), padding='same')

    x = filter_unit(x, 192, (3, 3), padding='same')
    x = filter_unit(x, 192, (3, 3), max_pooling=False, padding='same')
...
def xy():
    ...
    x = xy_unit(x, 128, (5, 5), padding='same')

    x = xy_unit(x, 192, (3, 3), padding='same')
    x = xy_unit(x, 192, (3, 3), max_pooling=False, padding='same')
...
def channel():
    ...
    x = channel_unit(x, 128, (5, 5), padding='same')

    x = channel_unit(x, 192, (3, 3), padding='same')
    x = channel_unit(x, 192, (3, 3), max_pooling=False, padding='same')
...
def original():
    ...
    x = conv_unit(img, 48, (11, 11), max_pooling=False, strides=(4, 4))
