...
def filter():
    ...
    x = ZeroPadding2D((3, 3))(img_input)
    x = filter_unit(x, 64, (7, 7), max_pooling=False, strides=(2, 2), activation='relu')
    x = MaxPooling2D((3, 3), strides=(2, 2))(x)
...
def xy():
    ...
    x = ZeroPadding2D((3, 3))(img_input)
    x = xy_unit(x, 64, (7, 7), max_pooling=False, strides=(2, 2), activation='relu')
    x = MaxPooling2D((3, 3), strides=(2, 2))(x)
...
def channel():
    ...
    x = ZeroPadding2D((3, 3))(img_input)
    x = channel_unit(x, 64, (7, 7), strides=(2, 2), max_pooling=False, activation='relu')
    x = MaxPooling2D((3, 3), strides=(2, 2))(x)
