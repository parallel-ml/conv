...
sudo /home/pi/perf/perf  stat -e $GENERAL,$BRANCH,$CACHE,$CAHCE_L1,$CACHE_LLC,$OS,$ARM -r $REPEAT -a ./siamese_fc_layer.py 10 
sudo /home/pi/perf/perf  stat -e $GENERAL,$BRANCH,$CACHE,$CAHCE_L1,$CACHE_LLC,$OS,$ARM -r $REPEAT -a ./siamese_fc_layer.py 8096 
