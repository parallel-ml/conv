...
def block2():
    img_input = Input(shape=(112, 112, 64))
...
def block3():
    img_input = Input(shape=(56, 56, 128))
...
def block4():
    img_input = Input(shape=(28, 28, 256))
...
def block6():
    img_input = Input(shape=(25088,))
    x = Dense(2048, activation='relu', name='fc1')(img_input)
    model = Model(img_input, x)
    return model
...
def block7():
    ...
    x = Dense(4096, activation='relu', name='fc2')(img_input)
    x = Dense(1000, activation='softmax', name='predictions')(x)
    model = Model(img_input, x)
    return model
